...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 16-07-2020 a las 01:41:38
...
CREATE TABLE `comentarios` (
  ...
  `opcional` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
INSERT INTO `comentarios` (`id`, `descripcionEgresado`, `descripcionAdministrador`, `fecha_creacion`, `tipo`, `opcional`, `respuesta`, `user_id`) VALUES
(3, '123124312412412541251', 'aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa', '2020-06-01', '1', 'no', 1, 1),
(4, ':CcCCCCc', 'Calla cmtre', '2020-06-23', '1', '123', 1, 2),
(6, 'Agregar', NULL, '2020-06-30', '1', '1', 0, 2),
(7, 'Hola como estas', NULL, '2020-07-14', '1', NULL, 0, 2);
...
INSERT INTO `distritos` (`id`, `nombre`, `pro_id`) VALUES
(1, 'CHACHAPOYAS', 1),
(2, 'ASUNCION', 1),
(3, 'BALSAS', 1),
(4, 'CHETO', 1),
...
CREATE TABLE `egresados` (
  ...
  `ingreso` varchar(200) COLLATE utf8mb4_unicode_ci NOT NULL,
  `egreso` varchar(200) COLLATE utf8mb4_unicode_ci NOT NULL,
...
INSERT INTO `egresados` (`id`, `codigo`, `celular`, `direccion`, `referencia`, `pais_id`, `departamento_id`, `provincia_id`, `distrito_id`, `persona_id`, `ingreso`, `egreso`, `estado`, `fecha_estado`) VALUES
(1, '201810802', '925628187', 'Urb San Julian,Jr Miraflores Manzana A2 Lote 9 y suiza la tino dx', 'Puente Santa Monica, Calle 6 con Calle 3', 1, 21, 170, 1682, 17, '2018', '2022', '0', NULL),
(2, '201811293', '987654321', 'Jr Lamas', 'No se pero si se papi preguntale a otro que sepa mi direcion pppp 3:', 1, 3, 1, 2, 18, '2018', '2023', '1', NULL),
(3, '201810825', '925625818', 'Hola Creaacion', ':3', 1, 3, 1, 1, 20, '2016', '2018', '0', NULL);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `egresados_escuelas`
--

CREATE TABLE `egresados_escuelas` (
  `id` int(11) NOT NULL,
...
--
-- Volcado de datos para la tabla `egresados_escuelas`
--

INSERT INTO `egresados_escuelas` (`id`, `egresado_id`, `escuela_id`) VALUES
(1, 1, 1),
(2, 2, 4),
(3, 3, 1);
...
CREATE TABLE `escuelas` (
  `id` int(11) NOT NULL,
  `nombre` varchar(200) COLLATE utf8mb4_spanish2_ci NOT NULL,
  `facultad_id` int(11) UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_spanish2_ci;
...
(1, 'Ing. de Sistemas', 1),
(2, 'Ing. Civil', 1),
(3, 'Ing. de Industrias Alimentarias', 1),
(4, 'Ing. Ambiental', 1),
(5, 'Enfermeria', 2),
(6, 'Psicologia', 2),
(7, 'Empresariales', 3),
(8, 'Contabilidad', 3),
(9, 'Administracion', 3),
(10, 'Educacion Inicial', 4),
(11, 'Educacion Primaria', 4),
(12, 'Lingustica', 4);
...
(5, 'Imagen Predefinida', '17Vjz_NRkunrHdZpL0frNDFX44_xY6VAp', '2487-12-12', '2001-12-27', '2018', 'Upeu', 1);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `experiencia_laborales`
--

CREATE TABLE `experiencia_laborales` (
  `id` int(11) NOT NULL,
  `empresa` varchar(200) COLLATE utf8mb4_spanish2_ci NOT NULL,
  `rubro_empresa` varchar(200) COLLATE utf8mb4_spanish2_ci NOT NULL,
  `cargo_ocupar` varchar(200) COLLATE utf8mb4_spanish2_ci NOT NULL,
  `area` varchar(200) COLLATE utf8mb4_spanish2_ci NOT NULL,
  `inicio` date NOT NULL,
  `final` date NOT NULL,
  `satisfacion` varchar(200) COLLATE utf8mb4_spanish2_ci NOT NULL,
  `descripcion` varchar(1000) COLLATE utf8mb4_spanish2_ci NOT NULL,
  `evidencia` varchar(200) COLLATE utf8mb4_spanish2_ci NOT NULL,
  `validado` tinyint(1) NOT NULL,
  `egresado_id` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_spanish2_ci;

--
-- Volcado de datos para la tabla `experiencia_laborales`
--

INSERT INTO `experiencia_laborales` (`id`, `empresa`, `rubro_empresa`, `cargo_ocupar`, `area`, `inicio`, `final`, `satisfacion`, `descripcion`, `evidencia`, `validado`, `egresado_id`) VALUES
(1, 'Infamous Inc', 'E-Sports', 'Analista de Sistemas', 'Analista', '2017-10-07', '2022-02-17', 'Insatisfechoss', 'Hice lo que pude', 'No tengo pero creeme p', 0, 1);
...
(2, 'Faculta de Ciencias de la Salud'),
(3, 'Facultad de Ciencias Empresariales'),
(4, 'Faculta de ciencias humanas y Educacion');
...
(65, '2020_06_28_181434_create_egresados_table', 12);
...
('daniel.saenz@upeu.edu.pe', '353q0J6KrNRwIqmgMJukHqQtN9Y0b2rUqey3qvGLn2ZdUzcBBYd0LNslDDWs', '2020-06-27 06:31:13');
...
CREATE TABLE `personas` (
  ...
  `distrito` int(5) DEFAULT NULL,
  `dni` varchar(8) COLLATE utf8_spanish_ci NOT NULL,
  `email` varchar(200) COLLATE utf8_spanish_ci NOT NULL,
  `fec_nacimiento` date NOT NULL,
  `est_civil` varchar(200) COLLATE utf8_spanish_ci DEFAULT NULL,
...
INSERT INTO `personas` (`id`, `nombre`, `ap_paterno`, `ap_materno`, `distrito`, `dni`, `email`, `fec_nacimiento`, `est_civil`, `sexo`, `validado`, `user_id`) VALUES
(17, 'Daniel', 'Sáenz', 'Shupingahua', 2, '70444029', 'daniel.saenz@upeu.edu.pe', '2001-12-27', 'Casado', 'Masculino', 1, 2),
(18, 'Maycol', 'Cahuana', 'Diaz', 1, '74473734', 'maycol.cahuana@upeu.edu.pe', '2002-01-27', 'Viudo', 'Masculino', 1, 21),
(20, 'Juan Gabriel', 'Pacco', 'No se :c', 4, '78979789', 'juan.pacco@upeu.edu.pe', '1212-12-12', 'Divorciado', 'Masculino', 1, 22),
(21, 'Luis Gustavo', 'Angles', 'Aguilar', 1682, '71411036', 'lgaa@upeu.edu.pe', '1990-08-18', NULL, 'Femenino', 1, 25),
(22, 'Caleb', 'Castañeda', 'Guevara', NULL, '45270150', 'caleb482@upeu.edu.pe', '1988-07-22', NULL, 'Femenino', 1, 26),
(23, 'Fredy Edgar', 'Afaraya', 'Herrera', 1499, '44101549', 'frech_8728@upeu.edu.pe', '1987-02-27', NULL, 'Femenino', 1, 24);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `postgrados_otros`
--

CREATE TABLE `postgrados_otros` (
  `id` int(11) NOT NULL,
  `agrado_academico` varchar(45) COLLATE utf8mb4_spanish2_ci DEFAULT NULL,
  `entidad` varchar(100) COLLATE utf8mb4_spanish2_ci DEFAULT NULL,
  `descripcion` varchar(220) COLLATE utf8mb4_spanish2_ci DEFAULT NULL,
  `desde` date DEFAULT NULL,
  `hasta` date DEFAULT NULL,
  `evidencias` varchar(45) COLLATE utf8mb4_spanish2_ci DEFAULT NULL,
  `egresado_id` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_spanish2_ci;

--
-- Volcado de datos para la tabla `postgrados_otros`
--

INSERT INTO `postgrados_otros` (`id`, `agrado_academico`, `entidad`, `descripcion`, `desde`, `hasta`, `evidencias`, `egresado_id`) VALUES
(5, 'Curso de Especialización', 'UPEU JULIACA', 'AEA', '2020-07-05', '2020-07-07', '123', 1),
(7, 'PhD', 'SOY PISDI P', 'ANaLISO MONGOLES', '2021-12-29', '2020-12-31', 'NO SEEE', 1);
...
(3, 'Egresado', 'Egre', 'Egresado o Usuario normal', NULL, NULL, NULL);
...
(7, 21, 'google', '116236623706586982349', 'https://lh3.googleusercontent.com/a-/AOh14GhpLNigp-E3lUA9eVy96xzD5XjgXTnKcC-oQ_Te', '2020-06-27 06:03:14', '2020-06-27 06:03:14');
...
(21, NULL, 'maycol.cahuana@upeu.edu.pe', '$2y$10$eHLggaxBTl6SsPtlHX9Iy.TrpRXREpV1iahy7/17HYe/Z4ouBodBq', NULL, '2020-06-27 06:03:14', '2020-06-27 06:25:20', 1, 1),
(22, NULL, 'juan.pacco@upeu.edu.pe', '$2y$10$omPd9YU66R/9nX1Ls5ntBesAedFemKHO4BDaSRa5QNQ5UQFSws7IG', NULL, '2020-07-10 20:35:59', '2020-07-10 20:36:29', 0, 1),
(24, NULL, 'frech_8728@upeu.edu.pe', '$2y$10$bLqh4DRKHX5jLRg.3chbMeELeUBgjsZa0Es1BRCMNGFS3PvIj7dSW', NULL, '2020-07-16 03:09:51', '2020-07-16 03:09:51', 1, 1),
(25, NULL, 'lgaa@upeu.edu.pe', '$2y$10$AWIrrYDMGq.XN2AD0xtUL.rf9KR3Qt0jUscgthjWto9FsDFjQIda2', NULL, '2020-07-16 03:48:30', '2020-07-16 03:48:30', 1, 1),
(26, NULL, 'caleb482@upeu.edu.pe', '$2y$10$JMskWbRmidZsLuCPd65Ln.zaKTqcjQw9cXwxMdfY3cMzB4D.bkAoq', NULL, '2020-07-16 04:23:13', '2020-07-16 04:23:13', 1, 1);
...
ALTER TABLE `egresados`
  ADD PRIMARY KEY (`id`),
  ADD KEY `egresados_pais_id_index` (`pais_id`),
  ADD KEY `egresados_departamento_id_index` (`departamento_id`),
  ADD KEY `egresados_provincia_id_index` (`provincia_id`),
  ADD KEY `egresados_distrito_id_index` (`distrito_id`),
  ADD KEY `egresados_persona_id_index` (`persona_id`) USING BTREE,
  ADD KEY `id` (`id`);

--
-- Indices de la tabla `egresados_escuelas`
--
ALTER TABLE `egresados_escuelas`
  ADD PRIMARY KEY (`id`),
...
--
-- Indices de la tabla `experiencia_laborales`
--
ALTER TABLE `experiencia_laborales`
  ADD PRIMARY KEY (`id`),
...
--
-- Indices de la tabla `postgrados_otros`
--
ALTER TABLE `postgrados_otros`
  ADD PRIMARY KEY (`id`),
  ADD KEY `egresado_id` (`egresado_id`);
...
--
-- AUTO_INCREMENT de la tabla `egresados_escuelas`
--
ALTER TABLE `egresados_escuelas`
...
--
-- AUTO_INCREMENT de la tabla `experiencia_laborales`
--
ALTER TABLE `experiencia_laborales`
...
--
-- AUTO_INCREMENT de la tabla `postgrados_otros`
--
ALTER TABLE `postgrados_otros`
...
--
ALTER TABLE `departamentos`
  ADD CONSTRAINT `departamentos_ibfk_1` FOREIGN KEY (`pais_id`) REFERENCES `paises` (`id`) ON UPDATE CASCADE;

--
-- Filtros para la tabla `distritos`
--
ALTER TABLE `distritos`
  ADD CONSTRAINT `distritos_ibfk_1` FOREIGN KEY (`pro_id`) REFERENCES `provincias` (`id`) ON UPDATE CASCADE;

--
-- Filtros para la tabla `egresados_escuelas`
--
ALTER TABLE `egresados_escuelas`
  ADD CONSTRAINT `egresados_escuelas_ibfk_1` FOREIGN KEY (`escuela_id`) REFERENCES `escuelas` (`id`) ON UPDATE CASCADE;

--
-- Filtros para la tabla `paises`
--
ALTER TABLE `paises`
  ADD CONSTRAINT `paises_ibfk_1` FOREIGN KEY (`id`) REFERENCES `departamentos` (`pais_id`) ON UPDATE CASCADE;

--
-- Filtros para la tabla `provincias`
--
ALTER TABLE `provincias`
  ADD CONSTRAINT `provincias_ibfk_1` FOREIGN KEY (`dep_id`) REFERENCES `departamentos` (`id`) ON UPDATE CASCADE;
